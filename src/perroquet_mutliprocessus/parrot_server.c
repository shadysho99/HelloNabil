...
main (int argc, char **argv)
{
    ...
    // Cette variable sert dans le cas où la réception (utilisation de recv) nécessite plusieurs appels
    char *str_parser;
    // Cette variable sert pour stocker le message recu
    ...
    while (1)
    {
        ...
        int pid;                                /* la variable utilisée pour le fork */
        ...
        {
            /*
             * On est dans le fils, on gère donc la communication
             */
